...
class SparseMat[@specialized(Double, Float) T](nr: Int, nc: Int, var nnz0: Int, var ir: Array[Int], val jc: Array[Int], val data: Array[T])(implicit manifest: Manifest[T], numeric: Numeric[T]) extends Mat(nr, nc) {
  ...
  def gt: SparseMat[T] = {
    explicitInds
    SparseMat.sparseImpl[T](
      SparseMat.uncompressInds(jc, ncols, ir),
...
object SparseMat {
  ...
  def apply[T](nr: Int, nc: Int, nnz0: Int)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] =
    new SparseMat[T](nr, nc, nnz0, new Array[Int](nnz0), new Array[Int](nc + 1), new Array[T](nnz0))

  def noRows[T](nr: Int, nc: Int, nnz0: Int)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] =
    new SparseMat[T](nr, nc, nnz0, null, new Array[Int](nc + 1), new Array[T](nnz0))

  def remdups[@specialized(Double, Float) T](rows: Array[Int], cols: Array[Int], avals: Array[T])(implicit manifest: Manifest[T], numeric: Numeric[T]): Int = {
    var i = 0
    var j = 0
    while (i < cols.length) {
  ...
  def sparseImpl[@specialized(Double, Float) T](rows: Array[Int], cols: Array[Int], vals: Array[T], nrows: Int, ncols: Int, nnz: Int)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] = {
    val ioff = Mat.ioneBased
  ...
  def newOrCheck[T](nr: Int, nc: Int, nnz: Int, oldmat: Mat, norows: Boolean = false)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] = {
  ...
  def newOrCheck[T](nr: Int, nc: Int, nnz0: Int, outmat: Mat, norows: Boolean, matGuid: Long, opHash: Int)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] = {
  ...
  def newOrCheck[T](nr: Int, nc: Int, nnz0: Int, outmat: Mat, norows: Boolean, guid1: Long, guid2: Long, opHash: Int)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] = {
    if (outmat.asInstanceOf[AnyRef] != null || !Mat.useCache) {
      newOrCheck(nr, nc, nnz0, outmat, norows)
    } else {
  ...
  def newOrCheck[T](nr: Int, nc: Int, nnz0: Int, outmat: Mat, norows: Boolean, guid1: Long, guid2: Long, guid3: Long, opHash: Int)(implicit manifest: Manifest[T], numeric: Numeric[T]): SparseMat[T] = {
    if (outmat.asInstanceOf[AnyRef] != null || !Mat.useCache) {
      newOrCheck(nr, nc, nnz0, outmat, norows)
    } else {
