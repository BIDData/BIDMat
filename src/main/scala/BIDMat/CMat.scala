...
case class CMat(nr:Int, nc:Int, data0:Array[Float]) extends DenseMat[Float](nr, nc, data0) {
  ...
  */ 
  ...
  override def *  (b : Double) = ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, null)
  override def +  (b : Double) = ccMatOpScalarv(b.toFloat, 0, CMat.vecAddFun, null)
  override def -  (b : Double) = ccMatOpScalarv(b.toFloat, 0, CMat.vecSubFun, null)
  override def *@ (b : Double) = ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, null)
  override def ∘  (b : Double) = ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, null)
  override def /  (b : Double) = ccMatOpScalarv(b.toFloat, 0, CMat.vecDivFun, null)
  
  override def == (b : Double) = ccMatOp(CMat.celem(b.toFloat, 0), CMat.eqFun, null)
  override def != (b : Double) = ccMatOp(CMat.celem(b.toFloat, 0), CMat.neFun, null)
  
  override def *  (b : Int) = ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, null)
  override def +  (b : Int) = ccMatOpScalarv(b.toFloat, 0, CMat.vecAddFun, null)
  override def -  (b : Int) = ccMatOpScalarv(b.toFloat, 0, CMat.vecSubFun, null)
  override def *@ (b : Int) = ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, null)
  override def ∘  (b : Int) = ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, null)
  override def /  (b : Int) = ccMatOpScalarv(b.toFloat, 0, CMat.vecDivFun, null)
  
  override def == (b : Int) = ccMatOp(CMat.celem(b.toFloat, 0), CMat.eqFun, null)
  override def != (b : Int) = ccMatOp(CMat.celem(b.toFloat, 0), CMat.neFun, null)
...
//  override def ^ (b : Mat) = mat.ccMatOp(b, (x:Float, y:Float) => math.pow(x,y).toFloat, null)  
  ...
  override def -  (b : Int) = mat.ccMatOpScalarv(b.toFloat, 0, CMat.vecSubFun, omat)
  override def *@ (b : Int) = mat.ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, omat)
  override def ∘  (b : Int) = mat.ccMatOpScalarv(b.toFloat, 0, CMat.vecMulFun, omat)
  override def /  (b : Int) = mat.ccMatOpScalarv(b.toFloat, 0, CMat.vecDivFun, omat)
     
  override def == (b : Int) = mat.ccMatOp(CMat.celem(b.toFloat, 0), CMat.eqFun, omat)
  override def != (b : Int) = mat.ccMatOp(CMat.celem(b.toFloat, 0), CMat.neFun, omat)
