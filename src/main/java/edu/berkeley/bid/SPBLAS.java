...
public final class SPBLAS {
  ...
  public static native  void smcscm( int transb, int m, int n, int k, float [] a, int lda, 
  		float [] b, int [] ir, int [] jc, float [] c, int ldc);
  
  public static native  void dmcscm( int transb, int m, int n, int k, double [] a, int lda, 
  		double [] b, int [] ir, int [] jc, double [] c, int ldc);
